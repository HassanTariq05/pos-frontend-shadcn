...
import { rentalAccountColumns as columns } from './rental-account-columns'
...
export function RentalAccounts({
  data,
  page,
  pageSize,
  totalPages,
  ...
  return (
    <div className={cn('flex flex-1 flex-col gap-4')}>
      <div className='flex flex-row items-center gap-4'>
        <h4 className='text-2xl font-bold tracking-tight'>Rental Accounts</h4>
        <Badge
          variant='outline'
          className={
